...
<h1 class="h3 mb-3"><strong>Pi Tool - Manufacturer</strong></h1>
    ...
    <div class="col-12 col-lg-12 col-xxl-12 d-flex">
        <div class="card flex-fill">
                <div class="card-header">
                    <h5 class="card-title mb-0">Linker <button id="integrationFind" class="btn btn-success btn-sm float-end btnAdd" data-bs-toggle="modal" data-bs-target="#formSaveModal">Save</button></h5>
...
<div class="row">
    <div class="col-12 col-lg-12 col-xxl-12 d-flex">
        <div class="card flex-fill">
                <div class="card-header">
                    <h5 class="card-title mb-0">New Manufacturer <button id="integrationFind" class="btn btn-success btn-sm float-end btnAdd" data-bs-toggle="modal" data-bs-target="#formSaveModal">Save</button></h5>
                    <div id="alerts-segmentation" style="width:100%;"></div>
                </div>
                <div class="card-body">  
                    <input type="text" class="form-control" id="add-manufacturer" name="add-manufacturer"/>                
                </div>            
        </div>
    </div>
</div>
<div class="row">
    <div class="col-12 col-lg-12 col-xxl-12 d-flex">
        <div class="card flex-fill">            
            <div class="card-header">
                <h5 class="card-title mb-0">Manufacturer List <!-- <button class="btn btn-success btn-sm float-end btnRC">RC Save</button> --></h5>
    ...
    $(document).ready(function() {
        ...
        table = $('#products').DataTable({
            ...
            "columns": [
                    ...
                    {
                        "data": "ingram_id", width:300
                    },
                    {
                        "data": "linker_id"
                    },
                    {
                        "data": "union_ingram_id"
                    },
                    {
                        "data": "created_at"
                    }
