        ...
        <ul class="navbar-nav navbar-align">
            ...
            <li class="nav-item dropdown">
                ...
                <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
                    <img src="<?= (file_exists('getSegmentation/'.$user['country']."/".$user['userID']."/avatar.jpg"))?base_url('getSegmentation/'.$user['country']."/".$user['userID']."/avatar.jpg"):base_url('assets/img/avatars/avatar.jpg') ?>" class="avatar img-fluid rounded me-1" alt="<?= $user['fullname']; ?>" /> <span class="text-dark"><?= $user['fullname']; ?></span>
                </a>
